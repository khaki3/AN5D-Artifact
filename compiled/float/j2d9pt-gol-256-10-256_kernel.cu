#include "j2d9pt-gol-256-10-256_kernel.hu"
...
#define AN5D_TYPE unsigned
    ...
    #define __CALCEXPR_0_wrap(__rn0, __a) do { __rn0 = ((((((((((7.1f * (__SBREF(__a_sb, -1))) + (5.1f * (__REGREF(__a, 0)))) + (9.2f * (__SBREF(__a_sb, 1)))))))))) / 118); } while (0)
    ...
    #define __REGREF(reg, i2) reg
    #define __SBREF(sb, i2) __sbref_wrap(sb, (int)__tid + i2)
    #define __CALCEXPR_1_wrap(__rn0, __a) do { __rn0 = ((((((((12.1f * (__SBREF(__a_sb, -1)))) + (15.f * (__REGREF(__a, 0)))) + (12.2f * (__SBREF(__a_sb, 1))))))) / 118); } while (0)
    #define __DB_SWITCH() do { __a_sb = &__a_sb_double[(__a_sb == __a_sb_double) ? __blockSize : 0]; } while (0)
    #define __CALCSETUP(a) do { __DB_SWITCH(); __a_sb[__tid] = a; __syncthreads(); } while (0)
    ...
    #define __REGREF(reg, i2) reg
    #define __SBREF(sb, i2) __sbref_wrap(sb, (int)__tid + i2)
    #define __CALCEXPR_2_wrap(__rn0, __a) do { __rn0 = (((((9.1f * (__SBREF(__a_sb, -1)))) + (5.2f * (__REGREF(__a, 0)))) + (7.2f * (__SBREF(__a_sb, 1)))) / 118); } while (0)
    #define __DB_SWITCH() do { __a_sb = &__a_sb_double[(__a_sb == __a_sb_double) ? __blockSize : 0]; } while (0)
    #define __CALCSETUP(a) do { __DB_SWITCH(); __a_sb[__tid] = a; __syncthreads(); } while (0)
